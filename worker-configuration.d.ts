/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 09fbd00bb26a835f2f1055027fa58829)
// Runtime types generated with workerd@1.20260430.1 2025-11-09 disable_nodejs_process_v2,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		DISCORD_WEBHOOK_GUESTBOOK: string;
		DISCORD_WEBHOOK_ASKS: string;
		DISCORD_UID: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ASTRO_DB_REMOTE_URL" | "ASTRO_DB_APP_TOKEN" | "TURNSTILE_SITE_SECRET" | "DISCORD_WEBHOOK_GUESTBOOK" | "DISCORD_WEBHOOK_ASKS" | "DISCORD_UID" | "PUBLIC_TURNSTILE_SITE_KEY">> {}
}
